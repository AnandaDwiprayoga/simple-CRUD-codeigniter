	...
	<div class="container">
	  ...
	  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
	    <div class="navbar-nav">
	      ...
	      <a class="nav-item nav-link" href="<?= base_url('User/Siswa') ?>">Data Siswa</a>
	      <a class="nav-item nav-link" href="<?= base_url('User/laporan_pdf') ?>">Cetak Mahasiswa</a>
	      <a class="nav-item nav-link" href="<?= base_url('User/laporan_pdf_User') ?>">Cetak Siswa</a>
